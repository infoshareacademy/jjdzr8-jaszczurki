...
public class EditOptions extends SubMenuNavigator{
    ...
    public static final String MISMATCHED_OFFER_NUMBER_MESSAGE = "Nie podano numeru oferty.";
    public static final String WRONG_OFFER_NUMBER_MESSAGE = "Oferta o podanym numerze nie istnieje.";
    ...
    public static final String CHANGES_CONFIRMATION_MESSAGE = "Czy na pewno chcesz zapisać zmiany? (tak/nie lub \"Enter\")";
